...
class Lts_RscShortcutButtonMain {
	color[] = { 1, 1, 1, 1 };
	colorDisabled[] = { 1, 1, 1, 0.25 };
	class HitZone {
		left = 0;
...
class Lts_RscButtonMenuCancel {
	shortcuts[] = { "0x00050000 + 1" };
	idc = 2;
	text = "Cancel";
};

class Lts_RscControlsGroup {
	deletable = 0;
	fade = 0;
	class VScrollbar {
		color[] = { 1, 1, 1, 1 };
